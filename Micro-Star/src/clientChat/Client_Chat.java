...
{
	// Beginning of declaration variables
    ...
    public void sendDisconnect() 
    {
        ...
        {
            ta_chat.append("Error! Could not send Disconnect message.\n");
        }
    }
    ...
    public void Disconnect() 
    {
        try 
        {
            ta_chat.append("Succesfully Disconnected.\n");
            sock.close();
        } catch(Exception ex) {
            ta_chat.append("Failure to disconnect. \n");
        }
        isConnected = false;
